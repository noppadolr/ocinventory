    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item {{ active_class(['supplier/*']) }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#emails" role="button" aria-expanded="{{ is_active_route(['supplier/*']) }}" aria-controls="emails">
                    <i class="link-icon" data-feather="truck"></i>
                    <span class="link-title">Manage Suppliers</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse {{ show_class(['supplier/*']) }}" id="emails">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('supplier/all') }}" class="nav-link {{ active_class(['supplier/all']) }}">All Supplier</a>
                        </li>
            ...
            <li class="nav-item {{ active_class(['customer/*']) }}">
                ...
                <div class="collapse {{ show_class(['customer/*']) }}" id="customer">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('customer/all') }}" class="nav-link {{ active_class(['customer/all']) }}">All Customer</a>
                        </li>
