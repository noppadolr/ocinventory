...
@section('title','All Cutomer')
@section('main')
    @push('css')
        <link rel="stylesheet" href="{{asset('admin/assets/vendors/datatables.net-bs5/dataTables.bootstrap5.css')}}">

    @endpush
    @include('backend.customer.add_customer_modal')
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <button type="button" class="btn btn btn-inverse-success" style="float: right;" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Customer</button>
                        <br>
